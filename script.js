...
function ultraConfetti(duration = 3200) {
  ...
  (function frame() {
    ...
    // sisi kiri kanan semburan tambahan
    confetti({
...
/* ------------------ background particle canvas lucu ------------------ */
